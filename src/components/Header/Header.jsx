        ...
        <div className="header-div">
            ...
            <div className="page-contents">
                ...
                <div className="social-links">
                    <a href="https://github.com/Leonardo-Figueiredo-do-Nascimento" target="_blank"><img id='github'  src="build/Photos/github-icon.png"/></a>
                    <a href="https://www.linkedin.com/in/leonardo-figueiredo-do-nascimento-087724231/?locale=en_US" target="_blank"><img src="build/Photos/linkedin-icon.png"/></a>
                    <a href="mailto:leonardofigueiredodonascimento@gmail.com"><img id='mail' src="build/Photos/email-icon-2.jpg"/></a>
                </div>
            </div>
        </div>
    )
